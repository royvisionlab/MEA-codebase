 ...
 */
public class RevGratGapFrameGenerator
    ...
    public RevGratGapFrameGenerator(
        int gapLocation, int gapWidth, double tPeriod, double sPeriod, double sPhase,
        int nReversals, double contrast) {
        ...
        this.sPhase = sPhase;
        this.nReversals = nReversals;
        this.contrast = contrast;
        this.gapLocation = gapLocation;
        this.nFrames = (int) Math.round(nReversals * tPeriod);
    }
    ...
    public void nextFrame(Object _frame) {
        ...
        frameIndex++;
        double x1 = gapLocation - gapWidth / 2;
        double x2 = gapLocation + gapWidth / 2;
    ...
    public static void main(String args[]) throws IOException {
        String movieFileName = "f:\\movies\\gapCRG.rawMovie";
        ...
        final int gapWidth = 150;
        final int hPadding = 100;
        final int nReversalsPerCondition = 24 * 8;
        int[] sPeriod = {24, 48, 96};

        ArrayList<RevGratGapFrameGenerator> list = new ArrayList();
        for (int gapLocation = hPadding; gapLocation <= width - hPadding;
                               gapLocation += stepSize) {
            for (int i = 0; i < sPeriod.length; i++) {
                list.add(new RevGratGapFrameGenerator(
                    gapLocation, gapWidth, tPeriod, sPeriod[i], 0,
        ...
        PrintWriter pw = new PrintWriter("f:\\movies\\gapCRG.txt");
        ...
        RawMovieFile file = new RawMovieFile(
            ...
            , "gapWidth" + AsciiHeaderFile.fieldSeparator + gapWidth
            ,
            "nReversalsPerCondition" + AsciiHeaderFile.fieldSeparator + nReversalsPerCondition
