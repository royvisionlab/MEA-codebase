...
public class DoubleHistogram
    ...
    public MeanVarianceCalculator mvc;
    ...
    public DoubleHistogram(
        String description, double[] bins, double min, double max) {
    ...
    public void enableCalculateStatisticsMode() {
        mvc = new MeanVarianceCalculator();
    }
    ...
    public void fill(double x1, double x2, double value) {
        int i1 = (int) ( (x1 - min) / binInterval);
        int i2 = (int) ( (x2 - min) / binInterval);
        for (int i = i1; i < i2; i++) {
            bins[i] += value;
        }
    }
