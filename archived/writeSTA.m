...
​
sta_copy = sta;
STA_array = cell(1,size(sta_copy,1));
clear sta
​
​
% STA params
...
sta.width = 78; % STA width in STIXELS
sta.height = 58; %40; % STA height in STIXELS
sta.depth = 30; %50; % How many frames back per STA
sta.stix_size = 30; %46.4000; % stixel size in microns
sta.refresh = 16.6550; % frame refresh in ms
​
n_cells = 464; %1205; % number of cells
​
​
​
